//[account-service-api](../../../index.md)/[classtime.service.account.event](../index.md)/[SignupEvent](index.md)/[ACQUISITION_CHANNEL_FIELD_NUMBER](-a-c-q-u-i-s-i-t-i-o-n_-c-h-a-n-n-e-l_-f-i-e-l-d_-n-u-m-b-e-r.md)
