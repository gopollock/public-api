//[account-service-api](../../../index.md)/[classtime.service.account](../index.md)/[AccountExtensionStateOrBuilder](index.md)

# AccountExtensionStateOrBuilder

interface [AccountExtensionStateOrBuilder](index.md) : MessageOrBuilder

#### Inheritors

| |
|---|
| [AccountExtensionState](../-account-extension-state/index.md) |
| [Builder](../-account-extension-state/-builder/index.md) |
...
| [getAccountExtensionId](get-account-extension-id.md) | [jvm]<br>abstract fun [getAccountExtensionId](get-account-extension-id.md)(): [String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html)<br>`string account_extension_id = 2;` |
| [getAccountExtensionIdBytes](get-account-extension-id-bytes.md) | [jvm]<br>abstract fun [getAccountExtensionIdBytes](get-account-extension-id-bytes.md)(): ByteString<br>`string account_extension_id = 2;` |
| [getAccountExtensionSecretHash](get-account-extension-secret-hash.md) | [jvm]<br>abstract fun [getAccountExtensionSecretHash](get-account-extension-secret-hash.md)(): ByteString<br>`bytes account_extension_secret_hash = 3;` |
