//[account-service-api](../../../index.md)/[classtime.service.account](../index.md)/[CreateTokenResponseOrBuilder](index.md)

# CreateTokenResponseOrBuilder

interface [CreateTokenResponseOrBuilder](index.md) : MessageOrBuilder

#### Inheritors

| |
|---|
| [CreateTokenResponse](../-create-token-response/index.md) |
| [Builder](../-create-token-response/-builder/index.md) |
...
| [getToken](get-token.md) | [jvm]<br>abstract fun [getToken](get-token.md)(): [String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html)<br>`string token = 1;` |
| [getTokenBytes](get-token-bytes.md) | [jvm]<br>abstract fun [getTokenBytes](get-token-bytes.md)(): ByteString<br>`string token = 1;` |
...
| [getValidUntil](get-valid-until.md) | [jvm]<br>abstract fun [getValidUntil](get-valid-until.md)(): Timestamp<br>`.google.protobuf.Timestamp valid_until = 2;` |
| [getValidUntilOrBuilder](get-valid-until-or-builder.md) | [jvm]<br>abstract fun [getValidUntilOrBuilder](get-valid-until-or-builder.md)(): TimestampOrBuilder<br>`.google.protobuf.Timestamp valid_until = 2;` |
...
| [hasValidUntil](has-valid-until.md) | [jvm]<br>abstract fun [hasValidUntil](has-valid-until.md)(): [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)<br>`.google.protobuf.Timestamp valid_until = 2;` |
