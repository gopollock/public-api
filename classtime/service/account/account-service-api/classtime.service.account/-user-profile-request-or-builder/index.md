//[account-service-api](../../../index.md)/[classtime.service.account](../index.md)/[UserProfileRequestOrBuilder](index.md)

# UserProfileRequestOrBuilder

interface [UserProfileRequestOrBuilder](index.md) : MessageOrBuilder

#### Inheritors

| |
|---|
| [UserProfileRequest](../-user-profile-request/index.md) |
| [Builder](../-user-profile-request/-builder/index.md) |
...
| [getAccountId](get-account-id.md) | [jvm]<br>abstract fun [getAccountId](get-account-id.md)(): [String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html)<br>`string account_id = 2;` |
| [getAccountIdBytes](get-account-id-bytes.md) | [jvm]<br>abstract fun [getAccountIdBytes](get-account-id-bytes.md)(): ByteString<br>`string account_id = 2;` |
