//[account-service-api](../../../index.md)/[classtime.service.account](../index.md)/[AccountExtensionRequestOrBuilder](index.md)

# AccountExtensionRequestOrBuilder

interface [AccountExtensionRequestOrBuilder](index.md) : MessageOrBuilder

#### Inheritors

| |
|---|
| [AccountExtensionRequest](../-account-extension-request/index.md) |
| [Builder](../-account-extension-request/-builder/index.md) |
...
| [getExtensionId](get-extension-id.md) | [jvm]<br>abstract fun [getExtensionId](get-extension-id.md)(): [String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html)<br>```kotlin Indicates relation to a pending AccountExtension entity. <br>``` `string extension_id = 2;` |
| [getExtensionIdBytes](get-extension-id-bytes.md) | [jvm]<br>abstract fun [getExtensionIdBytes](get-extension-id-bytes.md)(): ByteString<br>```kotlin Indicates relation to a pending AccountExtension entity. <br>``` `string extension_id = 2;` |
