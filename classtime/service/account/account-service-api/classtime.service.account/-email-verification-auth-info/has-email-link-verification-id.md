//[account-service-api](../../../index.md)/[classtime.service.account](../index.md)/[EmailVerificationAuthInfo](index.md)/[hasEmailLinkVerificationId](has-email-link-verification-id.md)
