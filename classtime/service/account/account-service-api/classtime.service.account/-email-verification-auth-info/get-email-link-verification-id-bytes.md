//[account-service-api](../../../index.md)/[classtime.service.account](../index.md)/[EmailVerificationAuthInfo](index.md)/[getEmailLinkVerificationIdBytes](get-email-link-verification-id-bytes.md)
