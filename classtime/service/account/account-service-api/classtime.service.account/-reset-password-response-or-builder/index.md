//[account-service-api](../../../index.md)/[classtime.service.account](../index.md)/[ResetPasswordResponseOrBuilder](index.md)

# ResetPasswordResponseOrBuilder

interface [ResetPasswordResponseOrBuilder](index.md) : MessageOrBuilder

#### Inheritors

| |
|---|
| [ResetPasswordResponse](../-reset-password-response/index.md) |
| [Builder](../-reset-password-response/-builder/index.md) |
...
| [getRedirectUrl](get-redirect-url.md) | [jvm]<br>abstract fun [getRedirectUrl](get-redirect-url.md)(): [String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html)<br>`string redirect_url = 1;` |
| [getRedirectUrlBytes](get-redirect-url-bytes.md) | [jvm]<br>abstract fun [getRedirectUrlBytes](get-redirect-url-bytes.md)(): ByteString<br>`string redirect_url = 1;` |
