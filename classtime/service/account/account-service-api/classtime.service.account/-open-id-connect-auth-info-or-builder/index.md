//[account-service-api](../../../index.md)/[classtime.service.account](../index.md)/[OpenIdConnectAuthInfoOrBuilder](index.md)

# OpenIdConnectAuthInfoOrBuilder

interface [OpenIdConnectAuthInfoOrBuilder](index.md) : MessageOrBuilder

#### Inheritors

| |
|---|
| [OpenIdConnectAuthInfo](../-open-id-connect-auth-info/index.md) |
| [Builder](../-open-id-connect-auth-info/-builder/index.md) |
...
| [getCode](get-code.md) | [jvm]<br>abstract fun [getCode](get-code.md)(): [String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html)<br>`string code = 1;` |
| [getCodeBytes](get-code-bytes.md) | [jvm]<br>abstract fun [getCodeBytes](get-code-bytes.md)(): ByteString<br>`string code = 1;` |
...
| [getScope](get-scope.md) | [jvm]<br>abstract fun [getScope](get-scope.md)(index: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)): [String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html)<br>`repeated string scope = 3;` |
| [getScopeBytes](get-scope-bytes.md) | [jvm]<br>abstract fun [getScopeBytes](get-scope-bytes.md)(index: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)): ByteString<br>`repeated string scope = 3;` |
| [getScopeCount](get-scope-count.md) | [jvm]<br>abstract fun [getScopeCount](get-scope-count.md)(): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)<br>`repeated string scope = 3;` |
| [getScopeList](get-scope-list.md) | [jvm]<br>abstract fun [getScopeList](get-scope-list.md)(): [List](https://docs.oracle.com/javase/8/docs/api/java/util/List.html)&lt;[String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html)&gt;<br>`repeated string scope = 3;` |
