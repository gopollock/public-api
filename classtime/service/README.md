...
- [class-service-api interface definition with its supported methods](https://beta-static.classtime.com/public-api/class-service-api/html/class-service-api/classtime.service.classes.api/-class-service/index.html).
- [session-service-api interface definition with its supported methods](https://beta-static.classtime.com/public-api/session-service-api/html/session-service-api/classtime.service.session.api/-session-service/index.html).